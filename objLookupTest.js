var interactions = {
	...
	'openingScr1': {						//Interaction 1
		...
		opt1: "1.     Fight",
		opt1Onclick: "fight.setUpFight('Cave Goblin')",
	},
	'openingScr2': {						//Interaction 2
		...
		opt1Onclick: "fight.setUpFight('Giant Spider')",
	...
	'fight3': {
		...
		opt1: "1.     Fight",
		opt1Onclick: "fight.setUpFight('Odd Man')",
	},
	'intrigued3': {
	...
	'trap5': {
		...
		opt1: "1.     Fight",
		opt1Onclick: "fight.setUpFight('Bandit')",
	},
	'loot5': {
	...
	'midgeMan6': {
		out: "You round the corner to see a man, no more than 3 and a half feet in height, practising his swordsmanship with a sword clearly made for someone larger than him. Letting off high pitch grunts of exertion with every stroke which is hte noise you mistook for a struggle."
	...
	'ahh6': {
		...
		opt1: "1.     Fight",
		opt1Onclick: "fight.setUpFight('Angry Midget')",
	},
	'leave6': {
	...
	'openingScr7': {						//Interaction 7
		...
		opt1: "1.     Oh dear...",
		opt1Onclick: "fight.setUpFight('Knight')",
	},
	'openingScr8': {						//Interaction 8
		...
		opt1Onclick: "changeOut('sacrifice8')",
	...
	'sacrifice8': {
		...
		+ "a massive explosion behind you. Startled, you turn to see that the fire has launched something directly for your face.",
		opt1: "1. 		Wait wha-",
	...
	'good8': {
		...
		+ "now clearly also pleased with the outcome as they are dancing round the fire cheering. Very confused at the whole situation, you head off with your new weapon in hand.",
		opt1: "1.  	Well then, onwards... I guess"
	},
	'great8': {
		out: "Before you start pulling, the weapon comes loose and falls into your hand. You can instantly tell the quality of it just be looking at it. You hear excitable whispering behind you from the spirits and they suddenly start cheering \"FIRE KING!!!\". The spirits rush to your side and "
		+ "start gleefully circling you. You don't really know what to make of the situation so you hold tight to your lovely new addition to your equipment and run back down the hill. The spirits try to chase you but thankfully you outrun them. That chant would get annoying very quickly...",
		opt1: "1. 		I can't wait to use this in my next fight"
	},
}
