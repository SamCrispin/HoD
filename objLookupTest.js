var interactions = {
    ...
    'loot3': {
        ...
        opt1: "1.	You gratefully accept his offer and leave him alone",
        opt1Onclick: "buildOpen",
        opt1params: ['loot', 3]
    },
    ...
    'trap9': {
        ...
        opt1Onclick: "buildFight",
        opt1params: ['Dual Wielding Bandit', 9]
    },
    'notTrap9': {
...
function setOutputDiv(chance, interaction1, interaction2, characteristic, limit) {
    ...
    opt1E.setAttribute("chance", interaction.opt1params[0]);
    opt1E.setAttribute("interaction1", interaction.opt1params[1]);
    opt1E.setAttribute("interaction2", (interaction.opt1params[2]) ? interaction.opt1params[2] : null);
    opt1E.setAttribute("characteristic", (interaction.opt1params[3]) ? interaction.opt1params[3] : null);
    opt1E.setAttribute("limit", (interaction.opt1params[4]) ? interaction.opt1params[4] : null);
    ...
    if (interaction.opt2 !== "") {
        opt2E.setAttribute("chance", interaction.opt2params[0]);
        opt2E.setAttribute("interaction1", interaction.opt2params[1]);
        opt2E.setAttribute("interaction2", (interaction.opt2params[2]) ? interaction.opt2params[2] : null);
        opt2E.setAttribute("characteristic", (interaction.opt2params[3]) ? interaction.opt2params[3] : null);
        opt2E.setAttribute("limit", (interaction.opt2params[4]) ? interaction.opt2params[4] : null);
	...
	if (interaction.blueOpt !== "") {
        blueOpt.setAttribute("chance", interaction.blueOptParams[0]);
        blueOpt.setAttribute("interaction1", interaction.blueOptParams[1]);
        blueOpt.setAttribute("interaction2", (interaction.blueOptParams[2]) ? interaction.blueOptParams[2] : null);
        blueOpt.setAttribute("characteristic", (interaction.blueOptParams[3]) ? interaction.blueOptParams[3] : null);
        blueOpt.setAttribute("limit", (interaction.blueOptParams[4]) ? interaction.blueOptParams[4] : null);
...
function buildOpen(e) {
    ...
    if (t.id == "opt1") {
        id = t.opt1params[0];
        compID = (t.opt1params[1]) ? t.opt1params[1] : null;
    }
    if (t.id == "opt2") {
        id = t.opt2params[0];
        compID = (t.opt2params[1]) ? t.opt2params[1] : null;
    }
    nav.open(id, compID);
}
...
function buildFight(e) {
    ...
    var t = e.target;
    if (t.id == "opt1") {
        eType = t.opt1params[0];
        interactionNo = t.opt1params[1];
    }
    if (t.id == "opt2") {
        eType = t.opt2params[0];
        interactionNo = t.opt2params[1];
    }
